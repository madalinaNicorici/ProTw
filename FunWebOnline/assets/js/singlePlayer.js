...
function openPlaySingle() 
{
	...
	getquiz.open("GET", "http://students.info.uaic.ro/~madalina.nicorici/FunWeb/index.php/quizzes/quiz/"+localStorage.user_id, true)
...
function getQuestion(){
	...
	if(i<10)
	{
		...
		mygetrequest.open("GET", "http://students.info.uaic.ro/~madalina.nicorici/FunWeb/index.php/questions/question/"+questions[i], true)
...
function getScore(){
	...
	mypostrequest.open("POST", "http://students.info.uaic.ro/~madalina.nicorici/FunWeb/index.php/scores/score/", true)
